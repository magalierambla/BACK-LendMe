...
public interface  likeDislikeProjectRepository extends JpaRepository<likeDislikeProjectModel, Long> {
	 ...
	 Optional<likeDislikeProjectModel>  findCheckLikeProject(String tokenUser,String tokenProject);
     ...
     @Query(value = "SELECT  *  FROM  like_dislike_project_user   WHERE  token_project=?1 ", nativeQuery = true)
	 List<likeDislikeProjectModel>  findAllLikesDislikesProject(String tokenProject);
