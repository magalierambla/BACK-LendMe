...
public class ProjectsController {
	...
	public ResponseEntity<project> createProject(@CurrentUser UserPrincipal currentUser,
			@Valid @RequestBody ProjetRequest newProject) {
	...
	@PreAuthorize("hasRole('USER')")
	@ResponseBody
	public ResponseEntity<project> updateProject(@CurrentUser UserPrincipal currentUser,
			@PathVariable String token_project, @Valid @RequestBody ProjetRequest updateProject) {
